...
-- AddForeignKey
ALTER TABLE "ConsentLog" ADD CONSTRAINT "ConsentLog_credentialId_fkey" FOREIGN KEY ("credentialId") REFERENCES "PortalCredential"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Channel" ADD CONSTRAINT "Channel_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES "ChannelTemplate"("id") ON DELETE SET NULL ON UPDATE CASCADE;
